...
Small indicates a small result set size or 4 results.
Large indicates a large result set or 8 results. If this argument is not supplied, a value of small is assumed.
"""
RSZ_SMALL = "small"
RSZ_LARGE = "large"
...
If this argument is not present the system will choose a value based on the value of the Accept-Language http header.
...
class Google(object):
        ...
        for page in range(0, self.pages):
            ...
            if print_results:
                if 'responseData' in data and 'results' in data['responseData']:
                    ...
                    self.logger.error('no responseData key found in response. very unusual')
            results.append(data)
        return results
    ...
    def search_page_wise(self):
        ...
        for page in range(0, self.pages):
            ...
            if 'responseData' in data and 'results' in data['responseData']:
                for result in data['responseData']['results']:
                    if result and 'unescapedUrl' in results:
